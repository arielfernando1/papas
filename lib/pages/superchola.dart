...
class SupercholaWidget extends StatefulWidget {
  const SupercholaWidget({Key? key}) : super(key: key);

  @override
  _SupercholaWidgetState createState() => _SupercholaWidgetState();
}

class _SupercholaWidgetState extends State<SupercholaWidget> {
